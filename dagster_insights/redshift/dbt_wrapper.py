...
def dbt_with_redshift_insights(
    ...
    """Wraps a dagster-dbt invocation to associate each Redshift query with the produced
    ...
    **Example:**
    ...
    if not skip_config_check:
        ...
        if adapter_type != "redshift":
            raise RuntimeError(
                f"The 'redshift' adapter must be used but instead found '{adapter_type}'"
            )
