...
def dbt_with_databricks_insights(
    ...
    """Wraps a dagster-dbt invocation to associate each Databricks query with the produced
    ...
    **Example:**
    ...
    if not skip_config_check:
        ...
        if adapter_type != "databricks":
            raise RuntimeError(
                f"The 'databricks' adapter must be used but instead found '{adapter_type}'"
            )
